 ...
 *
 * @author Jossibel Perez y Maria Chuico
 */
public class PantallaBienvenida extends JFrame {
    ...
    private void eventos() {
        ...
        this.btnAcerca.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent ae) {
                JOptionPane.showMessageDialog(PantallaBienvenida.this, "Universidad Nacional De Loja\n Juego Creado por Jossibel Perez y Maria Chuico\n Segundo Ciclo (A)\n Segunda Version", "Acerca de", JOptionPane.INFORMATION_MESSAGE, imgIcono);
            }
        });
